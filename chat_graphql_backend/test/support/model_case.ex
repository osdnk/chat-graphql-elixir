defmodule ChatGraphqlBackend.ModelCase do
  @moduledoc """
  ...
  using do
    quote do
      ...
      import Ecto.Query
      import ChatGraphqlBackend.ModelCase
    end
  end
  ...
  def errors_on(struct, data) do
    ...
    |> Ecto.Changeset.traverse_errors(&ChatGraphqlBackend.ErrorHelpers.translate_error/1)
